    ...
    `;const n=ns(o,this.config.customize),r=(null===(e=o.target)||void 0===e?void 0:e.domain)||(null===(t=n.target)||void 0===t?void 0:t.domain)||Wi(o.service),d=Be(null===(i=o.target)||void 0===i?void 0:i.domain)||Be(null===(s=o.target)||void 0===s?void 0:s.entity_id)||Be(o.service_data.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&(Be(null===(i=null===(t=ns(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)||Be(e.actions[0].service_data.entity_id))});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>_a(o,e,this.hass,this.config.customize));let c="";return c+="script"===r?gsIsCycleScriptService(o.service)?"循環模式":o.name||Os(o.service,this.hass,this.config.customize):fs(o,this.hass,this.config.customize,!1,!0),q`
      ...
      >
        ...
        <div slot="content">
          ...
          <scheduler-settings-row @click=${this._openEntityPicker}>
...
/**
    ...
    `}};t([le()],oo.prototype,"_hass",void 0),t([le()],oo.prototype,"datetime",void 0),oo=t([re("scheduler-relative-time")],oo);let no=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return q``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=$a(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Wi(r.service))&&(e=r.service),e&&(d=ea(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),q`
      <ha-icon
        icon="${d}"
